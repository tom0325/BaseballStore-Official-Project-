    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card mb-4 shadow-sm">
          <img src="images/off01.png" id="mypic" class="bd-placeholder-img card-img-top" width="100%" height="255" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false" title="打擊手套">
          <p class="card-header">
            ${data[0].description}
          </p>
...
<form action="addShopping" method="post" >
      ...
      <div class="col-md-4">
        <div class="card mb-4 shadow-sm">
          <img src="images/off02.png" id="mypic" class="bd-placeholder-img card-img-top" width="100%" height="255" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false" title="球棒">
          <p class="card-header">
            ${data[1].description}
          </p>
...
<form action="addShopping" method="post" >            
      ...
      <div class="col-md-4">
        <div class="card mb-4 shadow-sm">
          <img src="images/off03.png" id="mypic" class="bd-placeholder-img card-img-top" width="100%" height="255" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false" title="球">
          <p class="card-header">
            ${data[2].description}
          </p>
