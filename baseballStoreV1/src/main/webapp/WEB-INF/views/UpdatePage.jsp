...
<body style="background-image: url('images/01.jpg'); background-size: 100;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form action="updateMember" method="post"  class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Userphone is required">
						...
						<input class="input100" type="text" name="phone" placeholder="請輸入您的電話" value="${member.phone}" readonly >
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">Password</span>
						<input class="input100" type="password" name="password" placeholder="請輸入您的密碼" value="${member.password}">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
                    <div class="wrap-input100 validate-input" data-validate="Name is required">
						<span class="label-input100">Name</span>
						<input class="input100" type="name" name="name" placeholder="請輸入您的姓名" value="${member.name}">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Email is required">
						<span class="label-input100">Email</span>
						<input class="input100" type="email" name="email" placeholder="請輸入您的E-mail" value="${member.email}">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Address is required">
						<span class="label-input100">Address</Address></span>
						<input class="input100" type="address" name="address" placeholder="請輸入您的地址" value="${member.address}">
